...
echo ""
echo "Git transport:"
echo "  • HTTPS: GIT_ASKPASS=/tmp/git-askpass.sh GIT_TERMINAL_PROMPT=0 git push origin <branch>"
echo "  • SSH:   use git@github.com:owner/repo.git + your SSH key; commits still use bot identity above."
